...
class LabelUpdateController(QObject):
    ...
    def change_label(self, tuple_pair_id, new_label):
        ...
        ApplicationContext.COMPLETE_DATA_FRAME.loc[int(tuple_pair_id), ApplicationContext.LABEL_COLUMN] = new_label
        ApplicationContext.current_data_frame.loc[int(tuple_pair_id), ApplicationContext.LABEL_COLUMN] = new_label
