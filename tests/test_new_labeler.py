...
import os
import sys
from utils.generic_helper import get_install_path
from py_entitymatching.io.parsers import read_csv_metadata

if sys.version_info >= (3, 5):
    from labeler.new_labeler.new_labeler import new_label_table
    from labeler.new_labeler.utils import ApplicationContext
    from labeler.new_labeler.controller.FilterController import FilterController
    from labeler.new_labeler.controller.StatsController import StatsController
    from labeler.new_labeler.controller.LabelUpdateController import LabelUpdateController
    from labeler.new_labeler.controller.TuplePairDisplayController import TuplePairDisplayController
    from labeler.new_labeler.view import Renderer
else:
